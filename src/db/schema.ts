...
export const recipes = sqliteTable('recipes', {
  ...
  plateware_es: text('plateware_es'),
  ingredients_es: text('ingredients_es', { mode: 'json' }).$type<string[]>(),
  cook_steps_es: text('cook_steps_es', { mode: 'json' }).$type<string[]>(),
  plate_steps_es: text('plate_steps_es', { mode: 'json' }).$type<string[]>(),
